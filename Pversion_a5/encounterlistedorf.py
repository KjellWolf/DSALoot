...
dorf_fest =[
            ...
            "Eine besondere Persönlichkeit besucht das Dorf.",
            "Ein Adeliger besucht das Dorf",
            "Ein hoher Geweihter besucht das Dorf",
            "Ein bekannter Held besucht das Dorf"
           ]

dorf_trauer =[
            "Ein geschätztes Gemeindemitglied ist verstorben.",
            "Einige Dorfbewohner sind durch Hunger ums Leben gekommen.",
            "Einige Dorfbewohner sind durch Krankheit",
            "Einige Dorfbewohner sind durch ein Fluch",
            "Einige Dorfbewohner sind durch ein Überfall",
...
dorf_religion = [
                ...
                "Ein Prediger hetzt gegen Unglauben",
                "Ein Prediger hetzt gegen Adel",
                "Ein Prediger hetzt gegen Helden",
                "Ein Prediger hetzt gegen Sünde",
...
dorf_angriff = [
                ...
                "Ein Geist terrorisiert das Dorf.",
                "Ein Dämon terrorisiert das Dorf",
                "Ein Drache terrorisiert das Dorf"
               ]
...
dorf_bdorfbewohner = [
                    ...
                    "Eine Bewohnerin zeigt erstaunliche Ähnlichkeit mit einer berühmten Persönlichkeit.",
                    "Eine Bewohnerin zeigt erstaunliche Ähnlichkeit mit einer Schwerverbrecherin.",
...
dorf_verlassen = [
                ...
                "Alle Dorfbewohner sind in einem heiligen Wald in der Nähe, um einen Götterdienst zu halten."
                "Alle Dorfbewohner sind in einem heiligen Wald in der Nähe, um einen Feenpakt zu erneuern."
                 ]
