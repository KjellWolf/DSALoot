...
landst_orden = [
                ...
                "Eine Badilakanerin geleitet die Opfer eines Räuberüberfalls auf ihren Heimatort in die nächste Siedlung und bittet um Almosen.",
                "Eine Badilakanerin geleitet die Opfer eines Ogerüberfalls auf ihren Heimatort in die nächste Siedlung und bittet um Almosen.",
                "Eine Badilakanerin geleitet die Opfer eines Trollüberfalls auf ihren Heimatort in die nächste Siedlung und bittet um Almosen.",
...
landst_händler = [
                ...
                "Eine fahrende Händlerin bietet eine Schatzkarte an.",
                "Eine fahrende Händlerin bietet ein magisches Buch an."
                 ]
...
landst_bauer = [
                ...
                "Eine Gruppe mit Dreschflegeln und Sensen bewaffneter Bauern und Bäuerinnen suchen nach einem Schelm.",
                "Eine Gruppe mit Dreschflegeln und Sensen bewaffneter Bauern und Bäuerinnen suchen nach einem Ehebrecher.",
                "Eine Gruppe mit Dreschflegeln und Sensen bewaffneter Bauern und Bäuerinnen suchen nach einem Hühnerdieb.",
...
landst_gesetz = [
                ...
                "Ein Ritter mit seinem Gefolge folgt der Spur einer Orkbande und nimmt Hilfsangebote, gerne an.",
                "Ein Ritter mit seinem Gefolge folgt der Spur einer Goblinbande und nimmt Hilfsangebote, gerne an.",
                "Ein Ritter mit seinem Gefolge folgt der Spur einer Räuberbande und nimmt Hilfsangebote, gerne an.",
...
landst_unnatur = [
                "Ein Kobold hockt am Wegesrand und beschenkt grimmig schauende Reisende mit seinen Scherzen.",
